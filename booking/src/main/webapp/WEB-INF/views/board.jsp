		...
		<div class="d-flex flex-column">
			<section class="rb-bbs rb-bbs-list">
				...
				<div class="rb-bbs-body">
					<!-- <div data-bs-toggle="popover" data-bs-trigger="focus">
						<form></form>
						<div class="arrow"></div>
						...
						<tbody>
							<c:forEach items="${boardList}" var="board">
								<tr>
									...
									<td class="rb-title">
										<a href="">${board.title}<span class="badge"><%-- ${applyCount} --%></span></a>
									<td class="rb-user"><a class="btn btn-link" tabindex="0"
										role="button" data-profile="popover" data-original-title=""
										title="">${board.name}</a></td>
						...
						<div class="col-xs-12 col-sm-6 col-sm-offset-3">
							<form>
								<div class="input-group input-group-sm">
									<select class="selectpicker bs-select-hidden" title="掲示板検索"><option
											class="bs-title-option" value="">掲示板検索</option>
										<option>タイトル</option>
										<option>内容</option>
										<option>ID</option>
										<option>登録日</option>
